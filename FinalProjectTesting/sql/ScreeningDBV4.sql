...
-- ==============================================================
DROP DATABASE IF EXISTS ScreeningDB;
CREATE DATABASE IF NOT EXISTS `ScreeningDB` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `ScreeningDB`;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ScreeningDB`.`roles` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ScreeningDB`.`users` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ScreeningDB`.`subjects` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ScreeningDB`.`difficulty_level` (
  `id` INT NOT NULL,
  `name_ru` VARCHAR(45) NOT NULL,
  `name_en` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ScreeningDB`.`tests` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_tests_subject1`
    ...
    REFERENCES `ScreeningDB`.`subjects` (`id`)
    ON DELETE CASCADE
    ON UPDATE RESTRICT,
  CONSTRAINT `fk_tests_difficulty_level1`
    FOREIGN KEY (`difficulty_level_id`)
    REFERENCES `ScreeningDB`.`difficulty_level` (`id`)
    ON DELETE CASCADE
    ON UPDATE RESTRICT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ScreeningDB`.`questions` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_questions_tests1`
    FOREIGN KEY (`test_id`)
    REFERENCES `ScreeningDB`.`tests` (`id`)
    ON DELETE CASCADE
    ON UPDATE RESTRICT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ScreeningDB`.`answers` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ScreeningDB`.`results` (
  `id` INT NOT NULL AUTO_INCREMENT,
